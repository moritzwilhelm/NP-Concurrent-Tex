...
import com.pseuco.np19.project.slug.tree.inline.Hyphen;
import com.pseuco.np19.project.slug.tree.inline.InlineElement;
import com.pseuco.np19.project.slug.tree.inline.Space;
import com.pseuco.np19.project.slug.tree.inline.Special;
import com.pseuco.np19.project.slug.tree.inline.Syllable;
...
public class Paragraph extends BlockElement implements ParagraphBuilder {
	...
	public Paragraph(int segment, int index) {
		super(segment, index);
	}
